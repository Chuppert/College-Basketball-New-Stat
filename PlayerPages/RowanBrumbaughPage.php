...
<body>
    ...
    <div class="button-banner">
        <div class="header-buttons">
            <a href="Georgetown.php">Georgetown Players</a>
    ...
    <div class="container">
        ...
        <div class="player-column">
            <img src="PlayerPictures/<?php echo htmlspecialchars($player['first_name'] . $player['last_name']); ?>.jpg" alt="<?php echo htmlspecialchars($player['first_name'] . ' ' . $player['last_name']); ?>" class="player-image">
