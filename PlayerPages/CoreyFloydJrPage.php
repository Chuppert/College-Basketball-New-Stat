...
<head>
    ...
    <style>
        ...
        header {
            background: #333; /* Black banner behind title */
            color: #fff;
            padding: 10px 0;
            text-align: center;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="player-column">
            <img src="PlayerPictures/CoreyFloydJr..png" alt="<?php echo htmlspecialchars($player['first_name'] . ' ' . $player['last_name']); ?>" class="player-image">
